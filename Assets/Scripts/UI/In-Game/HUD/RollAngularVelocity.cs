...
public class RollAngularVelocity : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        float lastPitchAngle = SpaceShip.transform.localEulerAngles.z;;
    }
    ...
    void FixedUpdate()
    {
        ...
        float pitchDiff = Mathf.DeltaAngle(SpaceShip.transform.localEulerAngles.z, lastPitchAngle);
        lastPitchAngle = SpaceShip.transform.localEulerAngles.z;
        if(pitchDiff<0){
            pitchDiff = -pitchDiff;
        }
