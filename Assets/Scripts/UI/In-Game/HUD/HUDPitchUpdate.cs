...
public class HUDPitchUpdate : MonoBehaviour
{
    ...
    void Update()
    {
        float StationAngle = SpaceStation.rotation.eulerAngles.x;
        float ShipAngle = SpaceShip.rotation.eulerAngles.x;
        ...
        float valueAngle = StationAngle-ShipAngle;
